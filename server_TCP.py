    ...
    def handle(self):
        while True:
            ...
            try:
                ...
                print(f"Error dispatching OSC packet: {e}")
...
class ThreadingOSCTCPServer(socketserver.ThreadingTCPServer):
...
class TCPClient:
    ...
    def send_message(self, address, value):
        ...
        msg.add_arg(value)
        self._send_raw(msg.build().dgram)
...
def start_server(ip, port):
    ...
    server = ThreadingOSCTCPServer((ip, port), dispatcher)
