...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None):
        ...
        q = self.to_q(x.to(self.to_q.weight.dtype))
        k = self.to_k(context.to(self.to_k.weight.dtype))
        v = self.to_v(context.to(self.to_v.weight.dtype))
...
class BasicTransformerBlock(nn.Module):
    ...
    def _forward(self, x, context=None):
        temp = self.norm1(x.to(self.norm1.weight.dtype))
        x = self.attn1(temp) + x
