...
import torch
import numpy as np
from main.eval.eval_utils import load_and_chunk
...
MODEL_PATH = "lightning_logs/stream_music_gen/eval_models/cocola_models/checkpoint-epoch=87-val_loss=0.00.ckpt"
